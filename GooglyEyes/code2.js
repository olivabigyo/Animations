...
const handleMouseMove = function(event) {
    ...
    output.boxX.current = input.mouseX.current - output.boxX.grabDiff - output.boxX.start;
    output.boxY.current = input.mouseY.current - output.boxY.grabDiff - output.boxY.start;
    ...
    if(output.boxX.current < 200) {
        output.boxX.current = 200;
    }
    ...
    if (boxGrabbed) {
        ...
        output.boxX.start = output.boxX.start + output.boxX.current;
        output.boxY.start = output.boxY.start + output.boxY.current;  
    }
